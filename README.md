...
Preprint — Zenodo · CC BY 4.0 DOI: 10.5281/zenodo.21934507
...
`Post-Quantum Cryptography` · `Quantum Cryptanalysis` · `Learning Parity with Noise` · `Authentication Protocols` · `Superposition-Query Security Models` · `Applied Cryptography` · `Spectral Analysis of Boolean Functions` · `Secure Protocol Design` · `TLS Security` · `Cryptographic Inventory (CBOM)`
...
- **Independent research output**— deposited preprint on superposition leakage in LPN-based authentication
